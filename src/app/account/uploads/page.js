        ...
        <>
            {(!image) ? <input type="file" accept="image/*" ref={fileInputRef} className="hidden" onChange={(e) => handleImageChange(e)} /> :
                <div>
                    ...
                    <div className="m-5">
                        {(buttonLoading)
                        ?<button className="w-full h-full py-2 flex items-center justify-center bg-red-50 text-base font-semibold text-slate-900 rounded-sm"><SpinLoading h={8} w={8}/></button>
