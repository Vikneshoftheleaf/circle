                ...
                <Tabs defaultValue={`${memberView}`} className="w-full">
                    ...
                    <TabsContent value="follower">
                        {(members.followedBy != null)
                            ? members.followedBy.map(id => <MemberList key={id} id={id} profile={profile} type={'followers'} mode={'search'} />
                            )
                            : null
                        }
                    </TabsContent>
                    <TabsContent value="following">
                        {(members.followingBy != null)
                            ? members.followingBy.map(fid => <MemberList key={fid} id={fid} profile={profile} type={'following'} mode={'search'}/>
                            )
                            : null
                        }
